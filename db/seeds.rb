...
a4 = Account.create(currency: "GBP", bank_name: "Barclays", account_number: 56733478, sort_code: 345967, balance: 33522, user_id: demo_user.id)
...
at1 = Transaction.create(account_id: a4.id, amount: -10000, recipient: "Deposit Goal", time: "2021-05-16 19:00:14")
at2 = Transaction.create(account_id: a4.id, amount: -10000, recipient: "Deposit Goal", time: "2021-05-16 19:00:14")
at3 = Transaction.create(account_id: a4.id, amount: -3000, recipient: "Deposit Goal", time: "2021-05-16 19:00:14")
